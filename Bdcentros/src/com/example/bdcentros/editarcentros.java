...
public class editarcentros extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_editcentro);
		
		Button insertar = (Button)findViewById(R.id.cambiarcentro);
		...
		insertar.setOnClickListener(new OnClickListener() {
		 	...
		 	public void onClick(View v) {
		 		...
		 		String sentencia = "UPDATE centros SET  ('"+tip+"', '"+nom+"', '"+dir+"','"+tel+"','"+num+"') WHERE cod_centro=('"+cod+"')";
